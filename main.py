...
from transformation import VARIABLE_TRANSFORMATION
...
from cat_num import CAT_TO_NUM
...
if __name__ == '__main__':
    try:
        obj = TELE_CUSTOMER(f'C:\\Users\\nedur\\Downloads\\Project_number1\\Churn_Updated.csv')
        #obj.visualization()
        obj.missing_val()
        obj.var_out()
